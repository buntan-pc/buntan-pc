...
create_clock -period 20.8333 -name usb_clk -waveform {0 10.4167} [get_nets {usb_clk}]
# rPLL のジッタ（HCLK）の最大値は 30 mUI = 0.3125 ns
set_clock_uncertainty 1.0 -setup -from [get_clocks {usb_clk}] -to [get_clocks {usb_clk}]
